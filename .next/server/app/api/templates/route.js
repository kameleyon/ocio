"use strict";(()=>{var e={};e.id=412,e.ids=[412],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},25528:e=>{e.exports=require("next/dist\\client\\components\\action-async-storage.external.js")},91877:e=>{e.exports=require("next/dist\\client\\components\\request-async-storage.external.js")},25319:e=>{e.exports=require("next/dist\\client\\components\\static-generation-async-storage.external.js")},14300:e=>{e.exports=require("buffer")},6113:e=>{e.exports=require("crypto")},82361:e=>{e.exports=require("events")},13685:e=>{e.exports=require("http")},95687:e=>{e.exports=require("https")},41808:e=>{e.exports=require("net")},85477:e=>{e.exports=require("punycode")},12781:e=>{e.exports=require("stream")},24404:e=>{e.exports=require("tls")},57310:e=>{e.exports=require("url")},59796:e=>{e.exports=require("zlib")},32052:(e,t,s)=>{s.r(t),s.d(t,{headerHooks:()=>m,originalPathname:()=>h,patchFetch:()=>g,requestAsyncStorage:()=>l,routeModule:()=>D,serverHooks:()=>C,staticGenerationAsyncStorage:()=>d,staticGenerationBailout:()=>x});var n={};s.r(n),s.d(n,{GET:()=>p});var o=s(95419),r=s(69108),u=s(99678),i=s(78070),a=s(42303),c=s(81664);async function p(e){try{let{searchParams:t}=new URL(e.url),s=t.get("id"),n=(0,c.K)(),{data:o}=await n.auth.getSession();if(!o.session)return i.Z.json({error:"Authentication required"},{status:401});if(s){let e=(0,a.l3)(s);if(!e)return i.Z.json({error:"Template not found"},{status:404});return i.Z.json({template:{id:e.id,name:e.name,description:e.description,techStack:e.techStack,structurePreview:e.structure.slice(0,5)}})}let r=a.zd.templates.map(e=>({id:e.id,name:e.name,description:e.description,techStack:e.techStack}));return i.Z.json({templates:r,defaultTemplate:a.zd.default})}catch(e){return console.error("Error fetching templates:",e),i.Z.json({error:"Internal server error"},{status:500})}}let D=new o.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/templates/route",pathname:"/api/templates",filename:"route",bundlePath:"app/api/templates/route"},resolvedPagePath:"c:\\Users\\Administrator\\ocio\\app\\api\\templates\\route.ts",nextConfigOutput:"standalone",userland:n}),{requestAsyncStorage:l,staticGenerationAsyncStorage:d,serverHooks:C,headerHooks:m,staticGenerationBailout:x}=D,h="/api/templates/route";function g(){return(0,u.patchFetch)({serverHooks:C,staticGenerationAsyncStorage:d})}},42303:(e,t,s)=>{s.d(t,{NJ:()=>r,l3:()=>o,zd:()=>n});let n={templates:[{id:"react-vite",name:"React + Vite",description:"Modern React app with Vite, TypeScript, and Tailwind CSS",techStack:{frontend:"React, TypeScript, Tailwind CSS",backend:"None (Static)",database:"None"},structure:["\uD83D\uDCC1 {project-name}/","├── \uD83D\uDCC1 public/","│   ├── \uD83D\uDCC4 favicon.ico","│   └── \uD83D\uDCC4 robots.txt","├── \uD83D\uDCC1 src/","│   ├── \uD83D\uDCC1 components/","│   │   └── \uD83D\uDCC4 Button.tsx","│   ├── \uD83D\uDCC1 pages/","│   │   └── \uD83D\uDCC4 Home.tsx","│   ├── \uD83D\uDCC4 App.tsx","│   ├── \uD83D\uDCC4 main.tsx","│   └── \uD83D\uDCC4 index.css","├── \uD83D\uDCC4 index.html","├── \uD83D\uDCC4 vite.config.ts","├── \uD83D\uDCC4 tsconfig.json","├── \uD83D\uDCC4 tailwind.config.js","├── \uD83D\uDCC4 postcss.config.js","├── \uD83D\uDCC4 package.json","└── \uD83D\uDCC4 README.md"],baseFiles:[{path:"tsconfig.json",content:`{
  "compilerOptions": {
    "target": "ES2020",
