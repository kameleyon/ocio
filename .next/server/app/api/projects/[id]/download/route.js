"use strict";(()=>{var e={};e.id=419,e.ids=[419],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5528:e=>{e.exports=require("next/dist\\client\\components\\action-async-storage.external.js")},1877:e=>{e.exports=require("next/dist\\client\\components\\request-async-storage.external.js")},5319:e=>{e.exports=require("next/dist\\client\\components\\static-generation-async-storage.external.js")},4300:e=>{e.exports=require("buffer")},6113:e=>{e.exports=require("crypto")},2361:e=>{e.exports=require("events")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},1808:e=>{e.exports=require("net")},5477:e=>{e.exports=require("punycode")},2781:e=>{e.exports=require("stream")},4404:e=>{e.exports=require("tls")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},105:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>g,originalPathname:()=>w,patchFetch:()=>v,requestAsyncStorage:()=>h,routeModule:()=>u,serverHooks:()=>f,staticGenerationAsyncStorage:()=>m,staticGenerationBailout:()=>j});var o={};r.r(o),r.d(o,{GET:()=>l});var n=r(5419),a=r(9108),s=r(9678),i=r(8070),c=r(1664),p=r(2455),d=r(1581);async function l(e,{params:t}){(0,p.cookies)();let r=(0,c.e)();try{let{data:{session:e}}=await r.auth.getSession();if(!e)return i.Z.json({error:"Unauthorized"},{status:401});let o=t.id,{data:n,error:a}=await r.from("projects").select("*").eq("id",o).eq("user_id",e.user.id).single();if(a){if("PGRST116"===a.code)return i.Z.json({error:"Project not found"},{status:404});throw a}if("completed"!==n.status)return i.Z.json({error:"Project generation is not complete"},{status:400});if(n.download_url&&n.download_url.startsWith("http"))return i.Z.redirect(n.download_url);let s={name:n.name,description:n.description,techStack:n.tech_stack,files:[],structure:n.structure||[]},c=await (0,d.iq)(n.prompt,s),p=await (0,d.d6)(n.name,c),l=`project-zips/${o}/${n.name.toLowerCase().replace(/\s+/g,"-")}.zip`,u=await p.arrayBuffer(),h=Buffer.from(u),{error:m}=await r.storage.from("project-files").upload(l,h,{contentType:"application/zip",upsert:!0});if(m)throw m;let{data:f}=r.storage.from("project-files").getPublicUrl(l);return await r.from("projects").update({download_url:f.publicUrl}).eq("id",o),i.Z.redirect(f.publicUrl)}catch(e){return console.error("Error generating download:",e),i.Z.json({error:"Error generating download"},{status:500})}}let u=new n.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/projects/[id]/download/route",pathname:"/api/projects/[id]/download",filename:"route",bundlePath:"app/api/projects/[id]/download/route"},resolvedPagePath:"C:\\Users\\Administrator\\myAPP\\ocioweb\\app\\api\\projects\\[id]\\download\\route.ts",nextConfigOutput:"standalone",userland:o}),{requestAsyncStorage:h,staticGenerationAsyncStorage:m,serverHooks:f,headerHooks:g,staticGenerationBailout:j}=u,w="/api/projects/[id]/download/route";function v(){return(0,s.patchFetch)({serverHooks:f,staticGenerationAsyncStorage:m})}},1581:(e,t,r)=>{r.d(t,{bh:()=>s,d6:()=>c,eU:()=>p,iq:()=>i,lv:()=>a});var o=r(1883),n=r.n(o);async function a(e){try{let t=process.env.OPENROUTER_API_KEY||process.env.NEXT_PUBLIC_OPENROUTER_API_KEY,r=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`,"HTTP-Referer":"https://optimuscode.io"},body:JSON.stringify({model:"anthropic/claude-3-opus",messages:[{role:"system",content:'You are an expert web developer who helps name projects based on their descriptions. Generate a simple, memorable name for this project based on the prompt. Return ONLY the name, nothing else. The name should be short (1-2 words), catchy, and lowercase with hyphen if multiple words. Do not add any prefixes or suffixes like "app" or "io". Example: "task-flow" or "recipemaster"'},{role:"user",content:`Generate a project name for this app: ${e}`}],max_tokens:50})});if(!r.ok)throw Error(`AI API Error: ${r.status}`);return(await r.json()).choices[0].message.content.trim().replace(/"/g,"").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,"")||"new-project-"+Date.now().toString().slice(-6)}catch(e){return console.error("Error generating project name:",e),"new-project-"+Date.now().toString().slice(-6)}}async function s(e){try{let t=process.env.OPENROUTER_API_KEY||process.env.NEXT_PUBLIC_OPENROUTER_API_KEY,r=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`,"HTTP-Referer":"https://optimuscode.io"},body:JSON.stringify({model:"anthropic/claude-3-opus",messages:[{role:"system",content:`You are an expert full-stack developer. Given a prompt describing an app, generate project details including name, description, tech stack, and file structure. Return ONLY valid JSON in this format:
            {
              "name": "project-name",
