...
export default function jobRoutes(
   ...
   */
  router.post('/:id/cancel', async (req: Request, res: Response) => { // Add types
    try {
      const { id } = req.params;
   ...
   */
  router.get('/:id/status', async (req: Request, res: Response) => { // Add types
    try {
      const { id } = req.params;
   ...
   */
  router.get('/:id/result', async (req: Request, res: Response) => { // Add types
    try {
      const { id } = req.params;
   ...
   * DELETE /api/jobs
   */
  router.delete('/', (req: Request, res: Response) => { // Add types
