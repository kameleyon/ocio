...
export class JobQueue extends EventEmitter {
    ...
    async processJobs() {
        ...
        try {
            ...
            const pendingJobs = await this.storage.find('jobs', { status: JobStatus.PENDING });
     ...
     */
    async getJob(id) {
        const jobData = await this.storage.findById('jobs', id);
    ...
    async getJobs(status) {
        ...
        const jobsData = await this.storage.find('jobs', filter);
