...
export declare const GenerateMockDataSchema: z.ZodObject<{
    ...
    type: "custom" | "contact" | "event" | "user" | "product" | "post" | "comment" | "address" | "transaction" | "task";
    count: number;
    locale: string;
...
export declare const InsertMockDataSchema: z.ZodObject<{
    ...
    format: "json" | "js" | "ts";
    count: number;
    type?: "custom" | "contact" | "event" | "user" | "product" | "post" | "comment" | "address" | "transaction" | "task" | undefined;
    data?: any;
    customSchema?: Record<string, any> | undefined;
...
export declare const CustomizeMockDataSchema: z.ZodObject<{
    ...
    template: "custom" | "contact" | "event" | "user" | "product" | "post" | "comment" | "address" | "transaction" | "task";
    count: number;
